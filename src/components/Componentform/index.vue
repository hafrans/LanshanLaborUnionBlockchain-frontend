      ...
      <el-collapse v-model="activeNames">
        <el-collapse-item title="劳动合同规定内容" name="1">
          ...
          <el-form-item label="工资数">
            <el-input
              v-model.number="form.contract_wage"
              placeholder="请输入工资数"
              style="width:240px"
            /></el-form-item>
        ...
        <el-collapse-item title="实际工资发放情况" name="2">
          ...
          >
            <el-input
              ...
              placeholder="请输入实发工资数"
              style="width:220px"
            /></el-form-item>
          <el-form-item label="实发工资构成">
            <el-input
              v-model="form.wage_component"
              placeholder="请输入实发工资构成"
              style="width:220px"
            /></el-form-item>
          <el-form-item
            label="发放形式"
        ...
        <el-collapse-item title="停职留薪期限时间" name="3">
          <el-form-item label="劳动者(单位为月)">
            <el-input-number
              v-model="form.laborer_time"
              controls-position="right"
            /></el-form-item>
          <el-form-item label="用人单位(单位为月)">
            <el-input-number
              v-model="form.employer_time"
              controls-position="right"
            /></el-form-item>
        </el-collapse-item>
        ...
        <el-collapse-item
          title="双方解除或终止劳动关系前十二个月劳动者平均工资数额"
          name="6"
        >
        ...
        <el-collapse-item title="未带薪年休假天数" name="7">
          <el-form-item label="应休天数">
            <el-input
              v-model="form.should_rest"
              placeholder="请输入应休天数"
              style="width:240px"
            /></el-form-item>
          <el-form-item label="实修天数">
            <el-input
              v-model="form.real_rest"
              placeholder="请输入实修天数"
              style="width:240px"
            /></el-form-item>
          <el-form-item label="未休天数">
            <el-input
              v-model="form.not_take_days"
              placeholder="请输入未休天数"
              style="width:240px"
            /></el-form-item>
        </el-collapse-item>
        <el-collapse-item
          title="扣除加班工资后十二个月劳动者月平均工资数额"
          name="8"
        >
          <el-form-item label="金额">
            <el-input
              v-model="form.no_overtime_avg_wage"
              placeholder="请输入金额"
              style="width:240px"
            /></el-form-item>
